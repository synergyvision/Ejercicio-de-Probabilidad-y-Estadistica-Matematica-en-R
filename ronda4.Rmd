...
La respuesta correcta es la opción C. ya que la estadística $z-calculada$ para una prueba de una muestra simple cuando la varianza poblacional es conocida es:
...
El estadístico $z$ es la prueba de hipótesis apropiada de la media de la población cuando la población está normalmente distribuida con varianza conocida. El estadístico se calcula de la siguiente forma:
...
$$z=\displaystyle\frac{149750-145000}{\frac{24000}{\sqrt{36}}}$$

Por lo que, $z=1.19$. Así la respuesta correcta es la opción B.
...
Para un nivel $1\%$ de significancia el valor crítico de z es, $z-\text{critico}=2.33$. Cómo la prueba es de una cola y $H_a: \mu > \$145,000$ entonces el valor crítico de z es positivo. Por lo que la respuesta correcta es la opción B.
...
Se rechaza la hipótesis nula $H_o$ si $z>z-\text{critico}$. Cómo $1.19<2.33$ entonces Roberts no puede rechazar la hipótesis nula. La respuesta correcta es la opción B.
...
La hipótesis nula correcta es $H_0:\mu=3\text{hours}$. Por lo tanto la respuesta correcta es la opción A.
...
Así $z=-2.67$. Por lo que la respuesta correcta es la opción A.
...
Para un nivel $5\%$ de significancia el valor crítico de z es, $z-\text{critico}=z_{\alpha/2}=z_{0.025}=1.96$. Cómo la prueba es de dos colas y $H_a:\mu \ne 3\text{hours}$ entonces el valor crítico de z es $\pm 1.96$. Por lo que la respuesta correcta es la opción C.
...
Usando una estadística z el intervalo de confianza se puede calcular:
...
Se rechaza la hipóteisis nula $H_0$ si $z < -z_{\alpha/2}$ o $z > z_{\alpha/2}$. Cómo $-2.67 < -1.96$ entonces se rechaza la hipótesis nula. La respuesta correcta es la opción A.
...
$\sigma_0^2$ = Valor hipotético de la varianza poblacional.
...
\begin{array}{rl}
\chi^2_{n-1} &=\displaystyle\frac{(n-1)s^2}{\sigma_0^2}\\ \\
\chi^2_{29} &= \displaystyle\frac{29(325^2)}{300^2}\\\\
&= 34.03
\end{array}
$$

Para un nivel $5\%$ de significancia el valor crítico de $\chi^2_{29}$ es, $\chi^2_{29}-\text{critico}= \chi^2_{\alpha/2}= \chi^2_{0.025}=45.722$ por la derecha por ser una prueba de dos colas y $\chi^2_{1-\alpha/2}=\chi^2_{0.975}=16.047$ por la izquierda. 

Se rechaza la hipótesis nula $H_0$ si $\chi^2_{24} > \chi^2_{\alpha/2}$ y $\chi^2_{24} < \chi^2_{1-\alpha/2}$. Cómo $34.03 < 45.722$ y $34.03 > 16.047$ entonces no se puede rechazar la hipótesis nula. Es decir, la población y las variaciones de muestra no son significativamente diferentes, por lo que la respuesta correcta es la opción B.
...
$$t_{n-1} =\displaystyle\frac{\overline X-\mu_0}{\frac{s}{\sqrt{n}}}$$
...
\begin{array}{rl}
t_{n-1} &=\displaystyle\frac{\overline X-\mu_0}{\frac{s}{\sqrt{n}}}\\ \\
t_{24} &= \displaystyle\frac{50-48}{\frac{5}{\sqrt{25}}}\\\\
&=2
\end{array}
$$

Para un nivel $1\%$ de significancia el valor crítico de $t_{24}$ es, $t_{24}-\text{critico}=2.797$. Cómo la prueba es de dos colas entonces el valor crítico de $t_{24}$ es $\pm 2.797$. 

Se rechaza la hipótesis nula $H_0$ si $t_{24} < -t_{24}-\text{critico}$ o $t_{24} > t_{24}-\text{critico}$. Cómo $2 < 2.797$ y $2>-2.797$ entonces no se puede rechazar la hipótesis nula. La respuesta correcta es la opción A.
...
\begin{array}{rl}
\chi^2_{n-1} &=\displaystyle\frac{(n-1)s^2}{\sigma_0^2}\\ \\
\chi^2_{24} &= \displaystyle\frac{24(5^2)}{24}\\\\
&= 25
\end{array}
$$
...
Se rechaza la hipótesis nula $H_0$ si $\chi^2_{24} > \chi^2_{24}-\text{critico}$. Cómo $25 < 36.415$ y entonces no se puede rechazar la hipótesis nula. La respuesta correcta es la opción A.
...
Para un nivel $5\%$ de significancia el valor crítico de $t_{24}$ es, $t_{24}-\text{critico}=1.711$. Cómo la prueba es de una cola positiva entonces el valor crítico de $t_{24}$ es $+1.711$. 

Se rechaza la hipótesis nula $H_0$ si $t_{24} > t_{24}-\text{critico}$. Cómo $2 > 1.711$ entonces se rechaza la hipótesis nula. La respuesta correcta es la opción B.
...
\begin{array}{rl}
F &=\displaystyle\frac{s_2^2}{s_1^2}\\ \\
&= \displaystyle\frac{6^2}{5^2}\\\\
&=\displaystyle\frac{36}{25}\\\\
&= 1.44
\end{array}
$$

Para un nivel $5\%$ de significancia el valor crítico de $F$ es, $F-\text{critico}=F_{\alpha/2}=F_{0.025}=2.18$. 

Se rechaza la hipótesis nula $H_0$ si $F > F-\text{critico}$. Cómo $1.44 < 2.18$ entonces no se puede rechazar la hipótesis nula. La respuesta correcta es la opción A.
...
El estadístico de prueba apropiado para ésta prueba es el estadístico $F-\text{test}$. Por lo tanto la respuesta correcta es la opción B.
...
La estadística apropiada para ésta prueba es el estadístico $\chi^2-\text{test}$. La respuesta correcta es la opción C.
...
Hay un 5% de probabilidad de que la hipótesis nula sea rechazada cuando es realmente cierto, esto es la probabilidad de cometer un error Tipo I. La probabilidad de rechazar el nulo cuando es falso es 40%, la cual es llamado el poder de la prueba y es $1-P(\text{error tipo II})=1-0.6=0.4$.

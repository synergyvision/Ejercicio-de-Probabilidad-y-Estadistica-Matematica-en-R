...
Las propiedades deseables de un estimador son: Eficiencia, consistencia e imparcialidad, es decir, la menos probable de ser una propiedadd deseable de un estimador es la Confiabilidad. Por lo que la opción correcta es la A.
...
2. Se define por un solo parámetro, los grados de libertad son iguales al número de una muestra de observaciones menos uno, que es igual a $n-1$.

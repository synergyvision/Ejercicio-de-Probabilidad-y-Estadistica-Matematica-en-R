...
La respuesta correcta es la opción C. La hipótesis alternativa es mayor a $\$145.000$. $H_a: \mu > \$145.000$.
...
La hipótesis nula correcta es $H_0:\mu=3 \text{horas}$. Por lo tanto la respuesta correcta es la opción A.
...
\begin{array}{rl}
\mathcal Z &=\displaystyle\frac{\overline X-\mu_0}{\frac{\sigma}{\sqrt{n}}}\\ \\
&= \displaystyle\frac{2.5-3}{\frac{1.5}{\sqrt{64}}}\\\\
\mathcal Z&=-2.666
\end{array}
$$
...
Se rechaza la hipótesis nula $H_0$ si $F > F_{24,35,0.025}$. Cómo $1.44 < 2.18$ entonces no se puede rechazar la hipótesis nula. La respuesta correcta es la opción A.
...
La estadística apropiada para ésta prueba es el estadístico $\chi^2$. La respuesta correcta es la opción C.

...
\textbf{\underline{Solución:}}
Sea $X$ la variable aleatoria que representa la cantidad semanal de dinero gastado por una compañia durante largo tiempo en mantenimiento y reparaciones, donde $X$ está normalmente distribuida con media \$450 y desviación estándar \$20, $X\sim N(400,400)$

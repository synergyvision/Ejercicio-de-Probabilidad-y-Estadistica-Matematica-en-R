...
Sea $X$ el número de empleados que trabajan en  la fábrica de Hawai y $Y$ el número de empleados que trabajan en la fábrica de Texas. $X$ y $Y$ tienen distribución hipergeométrica con $N=60$, $n=20$,  $r_x=20$ y $r_y=40$. Por definicón la distribución hipergeométrica para $X$ y $Y$ es de la forma,

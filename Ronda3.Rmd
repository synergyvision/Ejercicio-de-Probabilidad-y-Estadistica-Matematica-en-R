...
Queremos calcular $\mathbb{P}(X>450)$. Para eso, normalizaremos la variable $X$, usando la variable normal estándar $Z=\displaystyle \frac{X-\mu}{\sigma}=\displaystyle \frac{X-400}{20} \sim N(0,1)$.
...
Luego, $\mu=\mathbb{E}(X)=\alpha\beta=(20)(1000)=20000$ y $\sigma^2=V(X)=\alpha\beta^2=(20)(1000)^2=20000000$.
...
```{r,comment=""}
gamma<-pgamma(30000,20,1/1000)
gamma
```

Por lo que , $\mathbb{P}(X\leq30000)=0.9781265$. Asi, $$\mathbb{P}(X>30000)=1-0.9781265= 0.02187347$$.
...
El costo (en cientos de dólares) de este tiempo improductivo, debido a producción perdida y costo de mantenimiento y reparación, está dado por $C=10+20Y+4Y^2$. Encuentre la media y la varianza de $C$.
...
$$\mu=\mathbb{E}(Y)=\displaystyle \frac{\alpha}{\alpha+\beta}$$ y $$\sigma^2=V(Y)=\displaystyle \frac{\alpha\beta}{(\alpha+\beta^2)(\alpha+\beta+1)}$$
...
Donde por definición $\mathbb{E}[(C^2)]$, está dado por,
...
&=2\left[\displaystyle \frac{y^5}{5}|_0^1-\displaystyle \frac{y^6}{6}|_0^1\right]\\
...
b) La ganancia de la demanda real de este artículo es de $$G=300(70)=21000$$

La gancia es de \$21,000.

El costo de de la cantidad ordenada mensualmente es de $$C=445(50)=22250$$
El costo es \$22,250.

Entonces, $$G-C=21000-22250=-1250$$

Esto quiero decir, que la empresa perderá \$1250 en un mes si coloca una
orden de 445 y la demanda real de 300 unidades.
...
| **Nivel de riesgo: categorías** | **Número de fondos** |
|:-------------------- |:-------------------------------:|
| Bajo | 7 |
| Bajo el promedio| 6 |
| Promedio | 3 |
